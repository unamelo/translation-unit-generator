...
<!-- Plugin description -->
**Translation Unit Generator** is a repository that provides a pure template to make it easier to create a new plugin project (check the [Creating a repository from a template][gh:template] article).
...
<idea-plugin>
  <id>org.jetbrains.plugins.translationUnitGeneratororg.jetbrains.plugins.translationUnitGenerator</id>
  <name>Template</name>
